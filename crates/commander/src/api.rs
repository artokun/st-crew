            ...
            let mut openapi = utoipa::openapi::OpenApiBuilder::new()
                ...
                .components(Some(
                    utoipa::openapi::ComponentsBuilder::new()
                        .schema_from::<todo::Todo>()
                        .schema_from::<todo::TodoError>()
                        .build(),
                ))
                .tags(Some([utoipa::openapi::tag::TagBuilder::new()
                    .name("todo")
...
mod todo {
    ...
    fn check_api_key(require_api_key: bool) -> Result<(), (StatusCode, Json<TodoError>)> {
        todo!()
    }
}
