...
var e = /*#__PURE__*/ t(require('isomorphic-ws'));
function n(t, e) {
  return (
...
var m,
  ...
  F = /*#__PURE__*/ (function () {
    ...
    return (
      ...
      (e.units = function (t, e) {
        ...
        return n ? (e || new E()).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + n) + 4 * t), this.bb) : null;
      }),
  ...
  x = /*#__PURE__*/ (function () {
    ...
    return (
      (t.prototype.pack = function (t) {
        return j.createServerStatEvent(t, this.clientsConnected);
      }),
      t
    );
  })();
...
var A = /*#__PURE__*/ (function () {
  ...
  R = /*#__PURE__*/ (function (t) {
    ...
    (s = t), ((i = r).prototype = Object.create(s.prototype)), (i.prototype.constructor = i), n(i, s);
    var o = r.prototype;
    return (
      (o.emit = function (e, n) {
        ...
        try {
          ...
          return (
            ...
            (t.ws.onmessage = function (e) {
              ...
              i.message && t.emit(m[i.messageType], i.message);
            }),
      ...
      (o.getServerStats = function () {
        var t = new d(1),
          ...
          n = A.createMessage(t, m.RequestServerStatEvent, e);
  ...
  L = Array.from(Object.keys(m)).reduce(function (t, e) {
    return (t[e] = e), t;
  }, {});
(exports.MessageTypes = L), (exports.SpaceTradersRT = R), (exports.default = R);
