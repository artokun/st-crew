...
const r = new Int32Array(2),
  o = new Float32Array(r.buffer),
  a = new Float64Array(r.buffer),
  c = 1 === new Uint16Array(new Uint8Array([1, 0]).buffer)[0];
var u;
!(function (t) {
...
class h {
  ...
  readFloat32(t) {
    return (r[0] = this.readInt32(t)), o[0];
  }
  readFloat64(t) {
    return (r[c ? 0 : 1] = this.readInt32(t)), (r[c ? 1 : 0] = this.readInt32(t + 4)), a[0];
  }
  writeInt8(t, e) {
    this.bytes_[t] = e;
  }
  ...
  writeFloat32(t, e) {
    (o[0] = e), this.writeInt32(t, r[0]);
  }
  writeFloat64(t, e) {
    (a[0] = e), this.writeInt32(t, r[c ? 0 : 1]), this.writeInt32(t + 4, r[c ? 1 : 0]);
  }
  getBufferIdentifier() {
...
var d,
  l = /*#__PURE__*/ (function () {
    ...
    return (
      ...
      (e.unpack = function () {
        return new b(this.id(), this.name());
      }),
...
var p,
  _ = /*#__PURE__*/ (function () {
    ...
    return (
      ...
      (e.action = function () {
        ...
        return t ? this.bb.readInt8(this.bb_pos + t) : d.Joined;
      }),
      (e.client = function (t) {
        var e = this.bb.__offset(this.bb_pos, 6);
        return e ? (t || new l()).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : null;
      }),
      (t.startClientUpdateEvent = function (t) {
        t.startObject(2);
      }),
      (t.addAction = function (t, e) {
        t.addFieldInt8(0, e, d.Joined);
      }),
  ...
  y = /*#__PURE__*/ (function () {
    ...
    return (
      ...
      (e.unpack = function () {
        return new I(null !== this.client() ? this.client().unpack() : null);
      }),
      (e.unpackTo = function (t) {
  ...
  I = /*#__PURE__*/ (function () {
    ...
    return (
      (t.prototype.pack = function (t) {
        var e = null !== this.client ? this.client.pack(t) : 0;
        return y.createInitClientEvent(t, e);
      }),
      t
    );
  })(),
  ...
  g = /*#__PURE__*/ (function () {
    ...
    return (
      (t.prototype.pack = function (t) {
        return w.createVec2(t, this.x, this.y);
      }),
      t
    );
  })();
...
var m,
  S = /*#__PURE__*/ (function () {
    ...
    return (
      ...
      (e.state = function () {
        ...
        return t ? this.bb.readInt8(this.bb_pos + t) : p.Idle;
      }),
      (e.position = function (t) {
        var e = this.bb.__offset(this.bb_pos, 12);
        return e ? (t || new w()).__init(this.bb_pos + e, this.bb) : null;
      }),
  ...
  O = /*#__PURE__*/ (function () {
    ...
    return (
      ...
      (e.units = function (t, e) {
        ...
        return n ? (e || new S()).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + n) + 4 * t), this.bb) : null;
      }),
      ...
      (e.unpack = function () {
        return new F(this.bb.createObjList(this.units.bind(this), this.unitsLength()));
      }),
      (e.unpackTo = function (t) {
  ...
  F = /*#__PURE__*/ (function () {
    ...
    return (
      (t.prototype.pack = function (t) {
        var e = O.createUnitsVector(t, t.createObjectOffsetList(this.units));
        return O.createInitStateEvent(t, e);
      }),
      t
    );
  })(),
  ...
  B = /*#__PURE__*/ (function () {
    ...
    return (
      (t.prototype.pack = function (t) {
        return k.createRequestServerStatEvent(t);
      }),
      t
    );
  })(),
  N = /*#__PURE__*/ (function () {
    ...
    return (
      ...
      (e.unpack = function () {
        return new j(this.clientsConnected());
      }),
      (e.unpackTo = function (t) {
...
var T = /*#__PURE__*/ (function () {
    ...
    return (
      ...
      (e.unpack = function () {
        var t,
          e = this;
        return new A(this.messageType(), null === (t = x(e.messageType(), e.message.bind(e))) ? null : t.unpack());
      }),
      (e.unpackTo = function (t) {
        var e,
          n = this;
        (t.messageType = this.messageType()),
          (t.message = null === (e = x(n.messageType(), n.message.bind(n))) ? null : e.unpack());
      }),
      t
    );
  })(),
  A = /*#__PURE__*/ (function () {
    ...
    return (
      (t.prototype.pack = function (t) {
        ...
        return T.createMessage(t, this.messageType, e);
      }),
      t
    );
  })(),
  P = /*#__PURE__*/ (function (n) {
    ...
    function r() {
      var t;
      return (
        ((t = n.call(this) || this).url = void 0), (t.ws = void 0), (t.url = 'ws://localhost:8080'), (t.ws = null), t
      );
    }
    (s = n), ((i = r).prototype = Object.create(s.prototype)), (i.prototype.constructor = i), e(i, s);
    var o = r.prototype;
    return (
      (o.emit = function (t, e) {
        return n.prototype.emit.call(this, t, e);
      }),
      (o.on = function (t, e) {
        return n.prototype.on.call(this, t, e);
      }),
      (o.connect = function () {
        try {
          var e = this;
          return (
            ...
            (e.ws.onmessage = function (t) {
              var n = new h(t.data),
                i = T.getRootAsMessage(n).unpack();
              i.message && e.emit(m[i.messageType], i.message);
            }),
            (e.ws.onerror = function (t) {
              e.emit('error', t);
            }),
            (e.ws.onclose = function (t) {
              e.emit('disconnect', { code: t.code, reason: t.reason }),
                setTimeout(function () {
                  return e.connect();
                }, 1e3);
            }),
      ...
      (o.getServerStats = function () {
        var t = new f(1),
          e = k.createRequestServerStatEvent(t),
          n = T.createMessage(t, m.RequestServerStatEvent, e);
  ...
  R = Array.from(Object.keys(m)).reduce(function (t, e) {
    return (t[e] = e), t;
  }, {});
export { R as MessageTypes, P as SpaceTradersRT, P as default };
